...
A curated list of [Webex Developer Resources](https://developer.webex.com), inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,421 | 🐛 218 | 🌐 Go | 📅 2026-08-27 and [awesome-python](https://github.com/vinta/awesome-python) ⭐ 316,450 | 🐛 15 | 🌐 Python | 📅 2026-08-25.
...
* Python
  ...
  * [err-backend-cisco-webex-teams](https://github.com/marksull/err-backend-cisco-webex-teams) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-08-26 - An errbot backend (by marksull).
...
* Node.js
  * [webex-js-sdk](https://github.com/webex/webex-js-sdk/tree/master/packages/node_modules/webex) ⭐ 204 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-27 - Wrapper maintained by Cisco's engineering group (by Cisco Webex).
...
* [SDK for Browsers](https://github.com/webex/webex-js-sdk#a-note-on-browser-usage) ⭐ 204 | 🐛 105 | 🌐 TypeScript | 📅 2026-08-27 - Integrate calling into your client-side JavaScript applications (by Cisco Webex).
