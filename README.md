...
A curated list of [Webex Developer Resources](https://developer.webex.com), inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 185,106 | 🐛 231 | 🌐 Go | 📅 2026-09-20 and [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,250 | 🐛 22 | 🌐 Python | 📅 2026-09-20.
...
* Node.js
  * [webex-js-sdk](https://github.com/webex/webex-js-sdk/tree/master/packages/node_modules/webex) ⭐ 205 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-22 - Wrapper maintained by Cisco's engineering group (by Cisco Webex).
...
* [SDK for Browsers](https://github.com/webex/webex-js-sdk#a-note-on-browser-usage) ⭐ 205 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-22 - Integrate calling into your client-side JavaScript applications (by Cisco Webex).
...
* [teams-space-archive](https://github.com/DJF3/Webex-Teams-Space-Archive-v2) ⭐ 78 | 🐛 3 | 🌐 Python | 📅 2026-06-20 - Archive messages to a single HTML file (by DJF3).
